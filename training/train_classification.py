...
class TextClassifier:
    ...
    def save_model(self, output_dir):
        ...
        self.model.save_pretrained(output_dir)  # Save the model (for sequence classification)
...
if __name__ == "__main__":
    model_name = "meta-llama/Llama-3.2-1B-Instruct"  # Or any sequence classification model
    ...
    classifier.evaluate()
    classifier.save_model(output_dir='./Sequence_classification_saved_model')  # New name for saving the model
